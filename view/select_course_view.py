...
class SelectCourseView:
    ...
    def save_select_course2(self):
        ...
        if status:
            msg.showinfo("info", "the select course was successfully done")
        else:
    ...
    def save_select_course(self):
        ...
        Button(self.master, text="save", width=15, bg="blue", font=("Arial", 14),
               command=self.save_select_course2).place(x=100, y=200)
