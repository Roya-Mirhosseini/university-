...
class Course(Base):
    ...
    _unit_number = Column("unit_number", String(10), nullable=False)
    _prerequisite = Column("prerequisite", String(20), nullable=False)
    _major = Column("major", String(20), nullable=False)
    _tongue = Column("tongue", String(14), nullable=False)
    _hold_type = Column("hold_type", String(40), nullable=False)
